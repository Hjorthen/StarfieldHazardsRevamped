...
public class HazardSystemItemsPatcher
{
    ...
    private void PatchInternal()
    {
        ...
        AddItem("Radiation Mesh Shield", "HS_Item_Restore_Radiation", "A lead-alloy mesh designed to soak up radiation, its nano-crystalline structure keeping excess weight to a minimum.", radiationRestoreMf, new RadiationMesh());
        ...
        AddItem("Outland Airfilter", "HS_Item_Restore_Airborne", "A replacement filter for standard issue spacesuits. Breathe the antartic air of old.", airborneRestoreMf, new BucketOfPaste());
    }
